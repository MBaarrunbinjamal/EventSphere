...
<head>
  ...
  <style>
    * {
    ...
    .btn:hover {
      background-color: rgba(216, 166, 0, 1);
    }
    ...
    #floatingButton {
      ...
      height: 60px;
      border-radius: 50%;
      background-color: #ffffff; /* Bootstrap purple */
      color: black;
      display: flex;
      align-items: center;
      justify-content: center;
  ...
  <div class="form-container">
    ...
    <form method="POST" action="{{ route('password.confirm') }}">
      ...
      <div class="form-group">
        ...
        <input type="password" id="password" name="password" placeholder="Enter your password" required autofocus autocomplete="current-password" />
      </div>
