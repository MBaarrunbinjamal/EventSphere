        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <figure>
                        <img alt="" class="img-responsive" src="organizer/assets/images/about-us.jpg">
                    </figure>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="organizer/assets/images/speakers/speaker-1.jpg">
                        </figure>
                ...
                <div class="col-md-4">
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="organizer/assets/images/speakers/speaker-2.jpg">
                        </figure>
                ...
                <div class="col-md-4">
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="organizer/assets/images/speakers/speaker-3.jpg">
                        </figure>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="organizer/assets/images/speakers/speaker-4.jpg">
                        </figure>
                ...
                <div class="col-md-4">
                    ...
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="organizer/assets/images/speakers/speaker-5.jpg">
                        </figure>
                ...
                <div class="col-md-4">
                    <div class="speaker">
                        <figure>
                            <img alt="" class="img-responsive center-block" src="organizer/assets/images/speakers/speaker-6.jpg">
                        </figure>
                        <h4>Jhon Smith</h4>
                        <p>CEO of Peren</p>
                        <ul class="social-block">
                ...
                <div class="col-md-12">
                    <ul class="grid">
                        ...
                        <li class="grid-item grid-item-sm-6">
                            <img alt="" class="img-responsive center-block" src="organizer/assets/images/photos/photos-1.jpg">
                        </li>

                        <li class="grid-item grid-item-sm-3">
                            <img alt="" class="img-responsive center-block" src="organizer/assets/images/photos/photos-2.jpg">
                        </li>

                        <li class="grid-item grid-item-sm-3">
                            <img alt="" class="img-responsive center-block" src="organizer/assets/images/photos/photos-3.jpg">
                        </li>
                    
                        <li class="grid-item grid-item-sm-3">
                            <img alt="" class="img-responsive center-block" src="organizer/assets/images/photos/photos-5.jpg">
                        </li>

                        <li class="grid-item grid-item-sm-3">
                            <img alt="" class="img-responsive center-block" src="organizer/assets/images/photos/photos-6.jpg">
                        </li>

                        <li class="grid-item grid-item-sm-3">
                            <img alt="" class="img-responsive center-block" src="organizer/assets/images/photos/photos-7.jpg">
                        </li>

                        <li class="grid-item grid-item-sm-3">
                            <img alt="" class="img-responsive center-block" src="organizer/assets/images/photos/photos-8.jpg">
                        </li>
